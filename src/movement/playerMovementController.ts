...
export class Controller{
    ...
    //private pointToMove:BABYLON.Vector3;
    //player character 
    ...
    private player_input(){
        ...
        this.scene.registerBeforeRender(()=> {
            ...
            pos.y+=1;
            ray = new BABYLON.Ray(pos, new BABYLON.Vector3(0,-1,0), 100);
            ...
            if (hit.distance<1.01){
                ...
                pos.y-=1;
                ray = new BABYLON.Ray(pos, new BABYLON.Vector3(0,0,1), 10);
        ...
        const jump = (()=>{
            ...
            const direction = new BABYLON.Vector3(0,this.character.physicsImpostor.mass*10*40,0);
    ...
    addMobileMovement(){
        ...
        var lastTouch:Touch;
        var observer:BABYLON.Observer<BABYLON.Scene>;
        ...
        const touch_input:BABYLON.ICameraInput<BABYLON.ArcRotateCamera> = {
            camera:this.camera,
            getClassName: ()=>{
                return "grzymCam"
            },
    ...
    constructor(scene: BABYLON.Scene, camera:BABYLON.ArcRotateCamera, character: BABYLON.AbstractMesh, characterSpeed: number ) {
        this.scene = scene;
